...
namespace CleanCodeTest.Aplication.Helper
{
    public class CustomFunctions
    {
        public QueryExpression BuildQuery(string entityName, string[] column, string conditionColum, string conditionValue)
        {
        ...
        public EntityReference GetEntityReference(IOrganizationService service, string entityName, string[] column, string conditionColum, string conditionValue)
        {
        ...
        public string GetEntityAttribute(IOrganizationService service, string entityName, string[] column, string conditionColum, string conditionValue)
        {
            QueryExpression query = BuildQuery(entityName, column, conditionColum, conditionValue);
            EntityCollection results = service.RetrieveMultiple(query);
            if (results.Entities.Count > 0)
        ...
        public Dictionary<string, object> GetEntityAttributes(IOrganizationService service, string entityName, string[] columns, string conditionColum, string conditionValue)
        {
        ...
        public bool EntityExist(IOrganizationService service, string entityName, string[] column, string conditionColum, string conditionValue)
        {
            QueryExpression query = BuildQuery(entityName, column, conditionColum, conditionValue);
        ...
        public bool HasAdminRole(IOrganizationService service, Guid systemUserId, Guid AdminRoleTemplateId)
        {
